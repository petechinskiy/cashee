...
{
    public class AdjoeAdvancePlusConfig
    {
        AndroidJavaObject javaAdvancePlusConfig;

        internal AdjoeAdvancePlusConfig(AndroidJavaObject javaAdvancePlusConfig)
        {
        ...
        public ArrayList GetSequentialEvents() {
            ...
            for (int i = 0; i < size; i++)
            {
                ...
                AdjoeAdvancePlusEvent advancePlusEvent = new AdjoeAdvancePlusEvent(javaEvent);
        ...
        public string StringLog() 
        {
            ...
            foreach (AdjoeAdvancePlusEvent seqEvent in sequentialEvents)
            {
                Debug.Log( "\n{" +
            ...
            foreach (AdjoeAdvancePlusEvent bonusEvent in bonusEvents)
            {
                Debug.Log("\n{" +
