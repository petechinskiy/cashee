...
namespace io.adjoe.sdk
{
    ...
    public class AdjoeAppDetails
    {
        private AndroidJavaObject appDetails;

        internal AdjoeAppDetails(AndroidJavaObject appDetails)
        {
        ...
        public ArrayList GetCategoryTranslations() {
            ...
            for (int i = 0; i < size; i++)
            {
                ...
                AdjoeCategoryTranslation categoryTranslation = new AdjoeCategoryTranslation(javaCategoryTranslation);
