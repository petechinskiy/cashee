...
namespace io.adjoe.sdk
{
    ...
    public class AdjoePartnerApp
    {
        ...
        internal AdjoePartnerApp(AndroidJavaObject partnerApp)
        {
        ...
        public AdjoePromoEvent? GetPromoEvent()
        {
            ...
            return new AdjoePromoEvent(javaEvent);
        }
        ...
        public AdjoeAdvancePlusConfig? GetAdvancePlusConfig()
        {
            ...
            {
                return new AdjoeAdvancePlusConfig(javaPlusConfig);
            }
            return null;
        }
        ...
        public AdjoeStreakInfo? GetStreakInfo() 
        {
            ...
            {
                return new AdjoeStreakInfo(javaStreakInfo);
            }
            return null;
        }
        ...
        public void ExecuteClick(string subId1, string subId2, Action successCallback, Action errorCallback)
        {
            object[] parameters =
            {
                Adjoe.GetCurrentContext(),
                Adjoe.webViewContainer,
                subId1,
                subId2,
        ...
        {
            return partnerApp.Call<long>("getRemainingUntilNextReward", Adjoe.GetCurrentContext());
        }
        ...
        public RewardLevel GetNextRewardLevel()
        {
            AndroidJavaObject javaRewardLevel =
                partnerApp.Call<AndroidJavaObject>("getNextRewardLevel", Adjoe.GetCurrentContext());
        ...
        public class RewardLevel
        {
            ...
            /// </summary>
            /// <remarks>
            /// This value may be used as a sort key and unique identifier among all reward levels of one <c>AdjoePartnerApp</c>.
            /// </remarks>
            public int Level { get; set; }

            /// <summary>
            /// The amount of seconds that the user has to play the <c>AdjoePartnerApp</c> to get this level's reward.
            /// </summary>
            /// <remarks>
        ...
        private class ClickListener : AndroidJavaProxy
        {
            ...
            public ClickListener(Action successCallback, Action errorCallback, Action alreadyClickingCallback) : base(
                "io.adjoe.sdk.AdjoePartnerApp$ClickListener")
            {
        ...
        private class ViewListener : AndroidJavaProxy
        {
            ...
            public ViewListener(Action successCallback, Action errorCallback, Action alreadyViewingCallback) : base(
                "io.adjoe.sdk.AdjoePartnerApp$ViewListener")
            {
                this.successCallback = successCallback;
                this.errorCallback = errorCallback;
